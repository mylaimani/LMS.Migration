...
{
    private readonly IBowlingProfileService _service;

    public BowlingController(IBowlingProfileService service)
    {
        _service = service;
    }

    /// <summary>
    /// Returns the full bowling profile for a player.
    /// Includes phase stats, over-by-over economy trend, and favourite/nemesis batters.
    /// </summary>
    ...
    public async Task<IActionResult> GetBowlingProfile(
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await _service.GetBowlingProfileAsync(
