-- =====================================================================
-- Migration: Add sixes/fours/threes/twos/ones to LMSClickHouseDB.player_bowling_phase
...
ALTER TABLE LMSClickHouseDB.player_bowling_phase
...
DROP VIEW IF EXISTS LMSClickHouseDB.player_bowling_mv;

CREATE MATERIALIZED VIEW LMSClickHouseDB.player_bowling_mv TO LMSClickHouseDB.player_bowling_phase AS
...
-- FROM LMSClickHouseDB.player_bowling_phase
-- WHERE bowler_id = 3
